...
At this moment, we're most active on Slack. You can get your invite by clicking on the Slack invite button on [codebuddies.org](http://codebuddies.org) and join the community by verifying your invitation through your e-mail.

## How do I contribute to this project?
**PLEASE go to _[contributing.md](contributing.md)_ and refer to the contribution steps listed there!** There are also helpful resources there, in case you get stuck. To add yourself as a contributor, please see the [How do I add myself as a contributor?](contributing.md#how-do-i-add-myself-as-a-contributor) section. All contributors follow a [Code of Conduct](https://github.com/codebuddiesdotorg/codebuddies/blob/release/CODE_OF_CONDUCT.md). 
